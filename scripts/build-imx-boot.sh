...
#    wget -nc https://github.com/toradex/i.MX-System-Controller-Firmware/raw/60d8c942f49012b6620f34800e2e9f11e45a9ef5/src/scfw_export_mx8qm_b0/build_mx8qm_b0/mx8qm-apalis-scfw-tcm.bin -P scfw-bin
    wget -nc https://github.com/toradex/i.MX-System-Controller-Firmware/raw/src/scfw_export_mx8qm_b0/build_mx8qm_b0/mx8qm-apalis-scfw-tcm.bin -P scfw-bin
fi
...
#    git clone --depth=1 --progress -b imx_5.4.70_2.3.0 https://github.com/nxp-imx/imx-mkimage/
    git clone --depth=1 --progress -b lf-5.15.71_2.2.1 https://github.com/nxp-imx/imx-mkimage/
fi
cd imx-mkimage
cp ../imx-seco-3.8.5/firmware/seco/mx8qmb0-ahab-container.img iMX8QM/mx8qmb0-ahab-container.img
